...
from printing.wysiwyg_ui import (
    ...
    save_wysiwyg_dialog_geometry, wysiwyg_dialog_stylesheet,
)
...
class MultiImageWysiwygPrintDialog(QDialog):
    def __init__(self, sources_by_kind: dict[str, list[ImageSourceInfo]], settings: QSettings, parent=None, theme_colors: dict[str, str] | None = None) -> None:
        ...
        self.setObjectName("multiImageWysiwygPrintDialog"); apply_wysiwyg_theme(self, theme_colors); self.setStyleSheet(wysiwyg_dialog_stylesheet(self.objectName())); self.setWindowTitle("Mehrere Bilder WYSIWYG drucken — BildBlick")
